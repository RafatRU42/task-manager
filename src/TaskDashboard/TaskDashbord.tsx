...
const TaskDashboard = () => {
  ...
  return (
    <div className="h-screen grid grid-cols-12 ">
      <div className="col-span-9 px-10 pt-10">
        <div className="flex justify-between items-center">
          ...
          <div className="flex gap-5">
            <button className="border-2 border-blue-300 hover:border-primary hover:bg-primary rounded-xl h-10 w-10  grid place-content-center text-blue-300 hover:text-white transition-all">
      ...
      <div className="flex-none dropdown mt-10 md:hidden">
      ...
      <div className="hidden md:grid col-span-3 border-l-2 border-blue-300 px-10 pt-10">
        <div>
          <h1 className="text-xl">Members</h1>
          <div className="flex gap-3 mt-3">
            <div className="h-10 w-10 rounded-xl overflow-hidden">
