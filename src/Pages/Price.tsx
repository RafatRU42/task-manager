		...
		<div className="grid max-w-md grid-cols-1 gap-6 mx-auto auto-rows-fr lg:grid-cols-3 lg:max-w-full">
			<div className="flex flex-col overflow-hidden border-2 rounded-md border-gray-700">
				...
				<div className="flex flex-col items-center justify-center px-2 py-8 ">
					...
					<button className="px-8 py-3 mt-6 text-lg font-semibold rounded sm:mt-12 btn-info text-white">Sign up</button>
				</div>
			</div>
			<div className="flex flex-col overflow-hidden border-2 rounded-md border-success">
				<div className="flex flex-col items-center justify-center px-2 py-8 space-y-4 ">
